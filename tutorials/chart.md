...
As the Example before does not make any sense to a pie lets just bake a pie. You need in gram:
```code
\```chart:pie
flour:300
sugar:100
...
so your cake would have the following ingredients:
...
or 
###vertical
`column with identifiers - separator - value of identifier`
